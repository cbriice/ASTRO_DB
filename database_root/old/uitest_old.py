import database_root.backend.toplayer_funcs as dbf
...
B200_file = dbf.create_machine_hdf5('exampledata.csv', build_id)
dbf.merge_build_to_master(MASTER_FILE, build_id, B200_file, B200_metadict)
force_metadict = {
    'sample_rate': '20',
    'num_sensors': '5',
}
force_file = dbf.create_sensor_hdf5('force', 'force_test_raw.csv', force_metadict)
dbf.merge_data_to_build(force_file, MASTER_FILE, 'force', build_id)
#with h5tbx.File(MASTER_FILE, 'r') as master:        
    #print(list(master[f'/builds/{build_id}'].keys()))
########
#dbf.scrub_file(MASTER_FILE)
'''
##### syntax to plot with matplotlib
'''
